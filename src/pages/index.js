        ...
        <Row>
          <Col lg={12} md={12}>
            ...
            <p className="leads text-center">
              ...
              d’entretien), une grande partie de sa production est éco
              responsable et permet de donner une seconde vie aux draps,
              serviettes, peignoirs, torchons et chiffons. Nous offrons un large
              choix de gamme de produits aux meilleurs prix tout en limitant
